...
def emit():
    ...
    doc["about"] = "GENERATED by verify_ours.py --emit — do not edit by hand. Inputs come from cases.json; the `expected` blocks below are pinned digests, and CI fails if regenerating this file changes a byte."
